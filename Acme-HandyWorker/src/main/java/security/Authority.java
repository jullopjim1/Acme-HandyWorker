...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMIN + "|" + Authority.CUSTOMER + "|" + Authority.ENDORSER + "|" + Authority.HANDY + "|" + Authority.REFEREE + "|" + Authority.SPONSOR + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority = new Authority();
		authority.setAuthority(Authority.HANDY);
		result.add(authority);
